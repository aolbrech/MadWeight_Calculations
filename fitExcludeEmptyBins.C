...
void fitExcludeEmptyBins() {
  ...
  TFile* InputFile = new TFile(" Events/RVR_RecoUnmatched_SingleGausTF_10000Evts_SmallerSteps_SecondRun/FitDeviation_UnmatchedReco_RVR_10000Evts.root ","r");
  TFile* OutputFile = new TFile(" Events/RVR_RecoUnmatched_SingleGausTF_10000Evts_SmallerSteps_SecondRun/LimitedFitResult_UnmatchedReco_RVR_ScdDerBothCutApplied.root ","RECREATE");
  ...
  float fitStart = -0.125;  //Initialize fitStart 
  float fitEnd = 0.125;    //Initialize fitEnd 
