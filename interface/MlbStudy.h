...
class MlbStudy{
  ...
  public:
   ...
   int LowestChiSq, LowestChiSq4Jets;                //Since Mqqb Values are set artificially high, only the first two chi-sq will be the lowest one in the case of only 4 jets!
