...
ReconstructedName = ['TTbarSemiLepton_Reco_PositiveMuon_JetCombi0.lhco', 'TTbarSemiLepton_Reco_NegativeMuon_JetCombi0.lhco', 'TTbarSemiLepton_Reco_PositiveElectron_JetCombi0.lhco', 'TTbarSemiLepton_Reco_NegativeElectron_JetCombi0.lhco']
ReconstructedFile = [file('TTbarSemiLepton_Reco_PositiveMuon_JetCombi0.lhco','r'), file('TTbarSemiLepton_Reco_NegativeMuon_JetCombi0.lhco','r'), file('TTbarSemiLepton_Reco_PositiveElectron_JetCombi0.lhco','r'), file('TTbarSemiLepton_Reco_NegativeElectron_JetCombi0.lhco','r')]
...
if len(sys.argv) != 3:
	...
	#Obtain the reconstructed and generator event numbers which need to be matched!
	for MatchingLine in EventMatchingFile:
		...
		if ( (LeptonType == 0 and MatchingWords[1] == "1" and MatchingWords[2] == "0" and MatchingWords[3] == "0" and MatchingWords[4] == "0")    #Positive muon
		  or (LeptonType == 1 and MatchingWords[1] == "0" and MatchingWords[2] == "1" and MatchingWords[3] == "0" and MatchingWords[4] == "0")    #Negative muon
		  or (LeptonType == 2 and MatchingWords[1] == "0" and MatchingWords[2] == "0" and MatchingWords[3] == "1" and MatchingWords[4] == "0")    #Positive electron
		  or (LeptonType == 3 and MatchingWords[1] == "0" and MatchingWords[2] == "0" and MatchingWords[3] == "0" and MatchingWords[4] == "0") ): #Negative electron
			GeneratorEventNumber = MatchingWords[5]
			ReconstructedEventNumber = MatchingWords[8]
